...
class Ui_mouseWin(object):
    def setupUi(self, mouseWin):
        ...
        self.gridLayout_2.addWidget(self.plotWid, 7, 0, 1, 4)
        ...
        self.saveButton = QtWidgets.QPushButton(mouseWin)
    ...
    def retranslateUi(self, mouseWin):
        ...
        self.saveButton.setText(_translate("mouseWin", "Save parameters"))
