...
class Ui_mouseWin(object):
    def setupUi(self, mouseWin):
        ...
        self.gridLayout.addWidget(self.resp_disp, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.trialLimLineEdit, 4, 2, 1, 1)
