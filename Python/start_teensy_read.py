...
def startTeensyRead(ser,mutex,START_TIME,all_mice,doors,live_licks,experiment_parameters):
    while True:
        try:
            #Uncomment
        ...
        mutex.lock()
        data_update.dataUpdate(START_TIME,mutex,ser,serIn,all_mice,doors,live_licks,experiment_parameters)  
        mutex.unlock()