...
def startTeensyRead(ser,mutex,START_TIME,all_mice,doors,live_licks,last_test,experiment_parameters,test_start_signal,odourwin):
    while True:
        try:
            #Uncomment
        ...
        mutex.lock()
        data_update.dataUpdate(START_TIME,mutex,ser,serIn,all_mice,doors,live_licks,last_test,experiment_parameters,test_start_signal,odourwin)  
        mutex.unlock()